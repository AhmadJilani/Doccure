...
if($pay_type=="CASH"){
$querysales = "INSERT INTO sales SET date = '$date', cstId = '$cstId', invNum = '$invNum', details = '$remarks', pay_type = '$pay_type', amount = '$nettotal', paid = '$nettotal' , balance = '0', ip='$ip' ";
mysqli_query($conn, $querysales);
}

if($pay_type=="COD"){
$querysales = "INSERT INTO sales SET date = '$date', cstId = '$cstId', invNum = '$invNum', details = '$remarks', pay_type = '$pay_type', amount = '$nettotal', paid = '0' , balance = '$nettotal', ip='$ip' ";
mysqli_query($conn, $querysales);
}
...
$queryx = "INSERT INTO products_ledger SET date = '$date', cstId = '$cstId', invNum = '$invNum', product_id = '$product_id', price = '$price', qty = '$quantity', totalAmnt = '$totalAmount' , discount = '$discount', netAmount = '$netAmount' ";
