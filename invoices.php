                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h2 class="table-avatar">
                                                        ...
                                                        <a href="patient-profile.php">Richard Wilson
                                                            <span>#PT0016</span></a>
                                                    </h2>
                                                </td>
                                                <td>$450</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h2 class="table-avatar">
                                                        <a href="patient-profile.php" class="avatar avatar-sm me-2">
                                                            <img class="avatar-img rounded-circle"
                                                                src="assets/img/patients/patient1.jpg" alt="User Image">
                                                        </a>
                                                        <a href="patient-profile.php">Charlene Reed
                                                            <span>#PT0001</span></a>
                                                    </h2>
                                                </td>
                                                <td>$200</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h2 class="table-avatar">
                                                        <a href="patient-profile.php" class="avatar avatar-sm me-2">
                                                            <img class="avatar-img rounded-circle"
                                                                src="assets/img/patients/patient2.jpg" alt="User Image">
                                                        </a>
                                                        <a href="patient-profile.php">Travis Trimble
                                                            <span>#PT0002</span></a>
                                                    </h2>
                                                </td>
                                                <td>$100</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h2 class="table-avatar">
                                                        <a href="patient-profile.php" class="avatar avatar-sm me-2">
                                                            <img class="avatar-img rounded-circle"
                                                                src="assets/img/patients/patient3.jpg" alt="User Image">
                                                        </a>
                                                        <a href="patient-profile.php">Carl Kelly
                                                            <span>#PT0003</span></a>
                                                    </h2>
                                                </td>
                                                <td>$350</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h2 class="table-avatar">
                                                        <a href="patient-profile.php" class="avatar avatar-sm me-2">
                                                            <img class="avatar-img rounded-circle"
                                                                src="assets/img/patients/patient4.jpg" alt="User Image">
                                                        </a>
                                                        <a href="patient-profile.php">Michelle Fairfax
                                                            <span>#PT0004</span></a>
                                                    </h2>
                                                </td>
                                                <td>$275</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h2 class="table-avatar">
                                                        <a href="patient-profile.php" class="avatar avatar-sm me-2">
                                                            <img class="avatar-img rounded-circle"
                                                                src="assets/img/patients/patient5.jpg" alt="User Image">
                                                        </a>
                                                        <a href="patient-profile.php">Gina Moore
                                                            <span>#PT0005</span></a>
                                                    </h2>
                                                </td>
                                                <td>$600</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h2 class="table-avatar">
                                                        <a href="patient-profile.php" class="avatar avatar-sm me-2">
                                                            <img class="avatar-img rounded-circle"
                                                                src="assets/img/patients/patient6.jpg" alt="User Image">
                                                        </a>
                                                        <a href="patient-profile.php">Elsie Gilley
                                                            <span>#PT0006</span></a>
                                                    </h2>
                                                </td>
                                                <td>$50</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h2 class="table-avatar">
                                                        <a href="patient-profile.php" class="avatar avatar-sm me-2">
                                                            <img class="avatar-img rounded-circle"
                                                                src="assets/img/patients/patient7.jpg" alt="User Image">
                                                        </a>
                                                        <a href="patient-profile.php">Joan Gardner
                                                            <span>#PT0007</span></a>
                                                    </h2>
                                                </td>
                                                <td>$400</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h2 class="table-avatar">
                                                        <a href="patient-profile.php" class="avatar avatar-sm me-2">
                                                            <img class="avatar-img rounded-circle"
                                                                src="assets/img/patients/patient8.jpg" alt="User Image">
                                                        </a>
                                                        <a href="patient-profile.php">Daniel Griffing
                                                            <span>#PT0008</span></a>
                                                    </h2>
                                                </td>
                                                <td>$550</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h2 class="table-avatar">
                                                        <a href="patient-profile.php" class="avatar avatar-sm me-2">
                                                            <img class="avatar-img rounded-circle"
                                                                src="assets/img/patients/patient9.jpg" alt="User Image">
                                                        </a>
                                                        <a href="patient-profile.php">Walter Roberson
                                                            <span>#PT0009</span></a>
                                                    </h2>
                                                </td>
                                                <td>$100</td>
