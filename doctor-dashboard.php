                ...
                echo "<tr>
                    <td>
                        <h2 class='table-avatar'>
                            ...
                            <a href='patient-profile.html'>" . htmlspecialchars($row['patientName']) . " <span>#PT" . rand(1000, 9999) . "</span></a>
                        </h2>
                    </td>
...
<footer class="footer footer-one">
    ...
    <p><i class="feather-mail"></i> <a href="https://doccure.dreamguystech.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="076368646472756247627f666a776b622964686a">[email&#160;protected]</a></p>
    </div>
    </div>
    </div>
    </div>
