...
<?php
    ...
    $query = "INSERT INTO cartpurchase SET customer_id = '$cstId', product_id = '$productId', product_name = '$productName' , price = '$productPrice', quantity = '$qty', totalAmount = '$totalAmount', discount = '$discount', netAmount = '$netAmount',ip='$ip' ";
    ...
    if (isset($_GET['delete_id'])) {
        ...
        if (mysqli_query($conn, $deleteQuery)) {
            echo '<script>window.location.href="purchase.php?deleted=1";</script>';
        } else {
            echo '<script>window.location.href="purchase.php?deleted=0";</script>';
        }
                ...
                <div class="row">
                    ...
                    <div class="col-md-7 col-lg-8 col-xl-9">
                                ...
                                <div class="col-lg-12 d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="text-end">
                                        <a title="Add Sales" class="btn btn-primary btn-sm" data-bs-toggle="modal"><i
                                                class="fas fa-plus-circle"></i> <a href="purchase.php?addSales=1">Add
                                                Purchase</a>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover table-center mb-0">
                                            ...
                                            <tbody>
                                                <?php 
                                                $sr=0;
													$queryproducts = "SELECT * FROM cartpurchase where ip='$ip' order by cart_id ";
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="table-action">
                                                            ...
                                                            <a href="purchase.php?delete_id=<?php echo $dataproducts['cart_id']; ?>"
                        ...
                        <div class="mt-2 d-flex justify-content-end">
                            <?php $querycart = "SELECT * FROM cartpurchase where cart_id='';" 
                            ?>
